...
/**
 * Game configuration settings manager. Handles persistence and access to game
 * parameters.
 */
public class Settings {

    private transient final Gson gson = new GsonBuilder().setPrettyPrinting().disableHtmlEscaping().create();
